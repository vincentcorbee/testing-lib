import { beforeAll, describe, test, expect, screen, user, page, wait } from '../../../../dist/index.js';
...
describe('Membership registration', () => {
  ...
  beforeAll(async () => {
    ...
    await loginUser('legal_guardian');
    await loginUser('debug');

    graphQL = new GraphQL({
      graphqlEndpoint: env.graphql_endpoint,
      ssoAccessToken: env.users.legal_guardian.sso_access_token,
