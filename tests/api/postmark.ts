...
type PostmarkOutboundParameters = {
  count?: number;
  offset?: number;
  status?: string;
  subject?: string;
...
export class Postmark {
  ...
  #getQueryParameters(parameters: Record<string, any> = {}) {
